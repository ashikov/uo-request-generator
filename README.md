...
известные последствия и желаемые действия, получает готовый текст и копирует
его в удобный канал подачи.
...
его fail closed только после точного сопоставления дословного evidence с
исходным вводом. Абзацы разделены пустой строкой и не содержат URL.
