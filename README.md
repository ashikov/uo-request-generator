...
проверенных общих нормативных основания как короткие связные абзацы, разделённые
пустой строкой, без URL.
Раздел `Прошу:` завершает основную часть заявки. LLM не получает тексты и ссылки
на нормы, не подбирает законодательство и не формирует индивидуальное юридическое
заключение. Невалидный или частичный ответ модели не показывается как готовая
заявка.
