...
Для beta принято консервативное rollout-условие: до пользовательского трафика
целевого класса оператор фиксирует надлежащее включение постоянного
no-logging request path и выдерживает не менее 24 часов. Header обязателен
и после этого интервала. Commit, mock-test и время merge сами по себе не
подтверждают начало договорного срока у провайдера. Выполнение условия и
сверка фактической конфигурации относятся к #229, а не к этому code change.
Ответ поддержки не является условием принятия такого ограниченного решения
по официальному техническому контракту.
...
Пока различие не разобрано и достаточность минимальной проверки не подтверждена,
перенос квалификации и #229 не завершены.
...
7. Только после успешной сверки и выполнения описанного выше 24-часового
   условия отключения логирования восстановите разрешённое состояние
