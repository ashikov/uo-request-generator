...
const impactJsonSchemaDescription =
  '<impact-role source="consequences" occurrence="exactly-once" preservation="semantic-over-lexical" paraphrase="natural-when-needed" subject-expansion="forbidden"> Помещай сюда весь смысл явно переданных consequences ровно один раз. Сохраняй фактический смысл, конкретность и объём, а не исходную лексическую форму. Лексически неестественную формулировку перефразируй естественно без добавления исполнителя, группы людей, обстоятельств или последствий.';
...
const requestDraftSystemPromptParts = [
  ...
  '<explicit-consequence-role source="consequences" owner="impact" circumstances="independent-input-only" duplicate-dynamic-role="forbidden" preservation="semantic-over-lexical" paraphrase="natural-when-needed" subject-expansion="forbidden"> Каждый явно переданный в consequences смысл помещай только в impact, в том числе когда последствие описывает вынужденное действие или способ справляться с проблемой. Не повторяй этот смысл в circumstances или другой динамической роли. Сохраняй фактический смысл и объём, а не исходную лексическую форму.',
  ...
  "- Явно переданные consequences имеют приоритет перед самостоятельно выводимым impact: сохрани все существенные сведения, их конкретность и фактический объём, но не исходную лексическую форму; не заменяй наблюдаемое последствие общим выводом и не превращай риск в событие",
  "- При нормализации явно переданных consequences сохраняй фактический смысл, конкретность и объём. Если исходная формулировка лексически неестественна для описанного действия и контекста, обязательно перефразируй её естественно: дословное копирование не считается нормализацией. Не добавляй исполнителя, объект, обстоятельства или последствия",
