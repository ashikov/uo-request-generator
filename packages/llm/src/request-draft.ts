...
const commonAreaPremisesCleaningPromptRules = [
  "- используй kind common_area_premises_cleaning, только если вход прямо указывает на уборку помещения общего пользования многоквартирного дома — например подъезда, лестничной площадки, коридора или холла — или на удаление загрязнения с его стен, дверей и других поверхностей либо с размещённых в нём элементов общего имущества многоквартирного дома, например кабин лифтов. Загрязнение кабины лифта, входной двери или стены само по себе не является проблемой лифта, двери или конструкции и не описывается как техническая неисправность. Не используй этот kind для уборки внутри квартиры, придомовой территории, контейнерной площадки или вывоза ТКО",
  "- для kind common_area_premises_cleaning evidence по отдельности или в совокупности должно подтверждать и проблему уборки или загрязнения, и помещение общего пользования многоквартирного дома либо элемент его общего имущества; не утверждай антисанитарное состояние, вред здоровью, наличие вредителей, запахи или другие последствия, которых нет во входе",
] as const;
