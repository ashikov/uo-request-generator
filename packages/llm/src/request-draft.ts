...
const requestDraftSystemPromptParts = [
  ...
  "description — свободное описание ситуации, а не готовое значение problem. До нормализации выдели существенные явно переданные факты, отношения между ними и возможные референты. Сначала определи правильный референт, затем назначь каждому смыслу владеющую роль.",
  "При разрешении референта учитывай не только близость существительного, но и семантическую естественность свойства. Сохраняй отношения между явно переданными фактами, не меняй обладателя свойства и не приписывай свойство другому объекту.",
  ...
  "При материальной неоднозначности не выбирай референт только ради связного текста: сохрани неоднозначность без приписывания свойства другому объекту и не придумывай новый факт, отношение, причину или свойство.",
