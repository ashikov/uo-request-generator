...
const requestDraftSystemPromptParts = [
  ...
  "- circumstances содержит только самостоятельные переданные сведения о существенных условиях проявления, временном способе эксплуатации и фактически предпринимаемых из-за проблемы действия; явно переданные consequences в эту роль не помещай; если самостоятельных обстоятельств нет, укажи null",
  ...
  '<explicit-consequence-role source="consequences" owner="impact" duplicate-dynamic-role="forbidden" paraphrase="natural-meaning-preserving" literal-copy="not-required" subject-expansion="forbidden"> Каждый явно переданный в consequences смысл помещай только в impact, в том числе когда последствие описывает вынужденное действие или способ справляться с проблемой. Не повторяй этот смысл в circumstances или другой динамической роли, если там нет отдельного необходимого содержания.',
  ...
  "- При нормализации явно переданных consequences сохраняй фактический смысл, но не копируй бытовую или лексически неестественную формулировку дословно. Если смысл однозначен, вырази его естественно для описанного действия и контекста, не добавляя фактов, обстоятельств или последствий",
