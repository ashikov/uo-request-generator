...
const requestDraftSystemPromptParts = [
  ...
  "Во всех исходных полях — description, location, consequences и desiredActions — до распределения по ролям выделяй явно названных участников и связанные с каждым факты. В location учитывай человека только как часть факта о месте, а в desiredActions — только как участника переданного факта, но не как адресата требования.",
  "Независимо от выбранной смысловой роли сохраняй каждого конкретного участника, его отношение к ситуации и фактический объём. Не объединяй разных участников, не меняй их количество и не переноси участника в другую роль с изменением смысла.",
  "Не заменяй конкретного человека социальной, возрастной или медицинской категорией. Явно названную группу сохраняй без расширения состава или количества. Местоимения и «мы» можно естественно нормализовать, не меняя фактический состав участников. Эмоциональную лексику можно нейтрализовать, но факты об участниках сохраняй.",
  "</explicit-participant-preservation>",
  ...
  "Сначала выбери outcome по смыслу всего входа. Только после выбора generated заполняй поля этой ветки. Правила заполнения generated не являются основанием объединять самостоятельные проблемы.",
  "- Выбирай multiple_issues, если во входе минимум две самостоятельные наблюдаемые проблемы: различаются предметы или объекты либо описаны независимые события, для них требуются отдельные действия и одна проблема не является причиной, проявлением, последствием или уточнением другой. Если объединение заставляет пользователя отправить одну заявку по разным самостоятельным вопросам, это multiple_issues",
  "- Выбирай generated для одной связанной проблемы, даже если у неё есть несколько признаков, последствий, желаемых действий и связанных мест проявления, одна причинно связанная цепочка, неизвестная причина или несколько элементов одного процедурного плана",
  "- Один лишь союз «и», несколько предложений или несколько действий не доказывают наличие самостоятельных проблем",
  ...
  "Сохраняй конкретные факты, место, длительность, повторяемость и масштаб. Нормализуй эмоции, не меняя фактов.",
